...
| `{WORKSPACE_ROOT}/_template/README.md` | workspace テンプレート置き場の案内 | 手順の正本ではない。新規 workspace へコピーしない |
| `{WORKSPACE_ROOT}/_template/plan-template.md` | `plan.md` の書式正本 | 見出し、項目名、記載欄の正本。作成手順はここに寄せない |
| `{WORKSPACE_ROOT}/_template/requirements-template.md` | `requirements.md` の書式正本 | ユーザー要件の初期正本。要件のみを置き、設計意図や判断過程は混ぜない。作成手順はここに寄せない |
...
- `plan.md` の見出しや項目名の確認: `{WORKSPACE_ROOT}/_template/plan-template.md`
- `requirements.md` の見出しや項目名の確認: `{WORKSPACE_ROOT}/_template/requirements-template.md`
...
workspace root は常に `{WORKSPACE_ROOT}` です。

初期配置の基本:

- すぐ着手する plan: `{WORKSPACE_ROOT}/active/`
- まだ着手せず待機させる plan: `{WORKSPACE_ROOT}/backlog/`
...
`{WORKSPACE_ROOT}/_template/plan-template.md` は、`plan.md` の書式正本です。
...
`{WORKSPACE_ROOT}/_template/requirements-template.md` は、`requirements.md` の書式正本です。
...
- `{WORKSPACE_ROOT}/_template/README.md` は template 置き場の案内であり、新規 workspace へコピーしない
...
- workspace パスが `{WORKSPACE_ROOT}/{active|backlog}/...` 配下にあるか
...
- plan 書式の正本は常に `{WORKSPACE_ROOT}/_template/plan-template.md`
- requirements 書式の正本は常に `{WORKSPACE_ROOT}/_template/requirements-template.md`
