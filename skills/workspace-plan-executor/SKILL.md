...
- workspace root は `/agent_work/workspaces/` とする
...
1. 作業目的が理解できるか
2. workspace パスが `/agent_work/workspaces/{backlog|active|archive}/...` 配下か
